...
\\endlastfoot\n""")
  ...
  #   labelbottom='off') # labels along the bottom edge are off
		#plt.xticks(np.arange(1,6))
			...
			if VUR in collapsed_dict:
				collapsed_dict[VUR].append(" & "  + str(prev).title()+ " & " + str(VUR) + " & " + "\\includegraphics[width = 2cm, height = 0.5cm]{" + str(prev) + "combined} \\\\ \n")
				new_collapsed[VUR].append(str(prev))
			else:
				new_collapsed[VUR] = [str(prev)]
				collapsed_dict[VUR] =[" & "  + str(prev).title()+ " & " + str(VUR) + " & " + "\\includegraphics[width = 2cm, height = 0.5cm]{" + str(prev) + "combined} \\\\ \n"]
		...
		if str(x[1]) == "FRIENDS":
			if count in friends_dict:
				friends_dict[count].append(" & "  + str(prev).title()+ " & " + str(count) + "\% & " + "\\includegraphics[width = 2cm, height = 0.5cm]{" + title + "} \\\\  \n")

			else:
				
				friends_dict[count] = [" & "  + str(prev).title()+ " & " + str(count) + "\% & " + "\\includegraphics[width = 2cm, height = 0.5cm]{" + title + "} \\\\  \n"]
			for i in numbers:
			...
			if count in work_dict:
				work_dict[count].append(" & "  + str(prev).title()+ " & " + str(count) + "\% & " + "\\includegraphics[width = 2cm, height = 0.5cm]{" + title + "} \\\\  \n")
			else:

				work_dict[count] = [" & "  + str(prev).title()+ " & " + str(count) + "\% & " + "\\includegraphics[width = 2cm, height = 0.5cm]{" + title + "} \\\\  \n"]
			for i in numbers:
			...
			if count in pub_dict:
				pub_dict[count].append(" & "  + str(prev).title()+ " & " + str(count) + "\% & " + "\\includegraphics[width = 2cm, height = 0.5cm]{" + title + "} \\\\  \n")
			else:
				pub_dict[count] = [" & "  + str(prev).title()+ " & " + str(count) + "\% & " + "\\includegraphics[width = 2cm, height = 0.5cm]{" + title + "} \\\\  \n"]
			for i in numbers:
			...
			if count in app_dict:
				app_dict[count].append(" & "  + str(prev).title()+ " & " + str(count) + "\% & " + "\\includegraphics[width = 2cm, height = 0.5cm]{" + title + "} \\\\ \n")
			else:
				app_dict[count] = [" & "  + str(prev).title()+ " & " + str(count) + "\% & " + "\\includegraphics[width = 2cm, height = 0.5cm]{" + title + "} \\\\ \n"]
			for i in numbers:
  ...
  #   labelbottom='off') # labels along the bottom edge are off
	...
	plt.axis('off')
	savefig("recipient_friends", dpi=None, facecolor='w', edgecolor='w',
			orientation='portrait', papertype=None, format=None,
			transparent=False, bbox_inches='tight', pad_inches=0,
			frameon=None)
	plt.clf()
	VUR = str(round(float(recipient_friends.count(5))/len(recipient_friends),4)*100)
	recipient_dic[VUR] = "& FRIENDS & " + VUR +" & " + str(fvariance)+ " & \\includegraphics[width = 2cm, height = 2cm]{../recipient_friends}\\\\ \n"
	...
	plt.axis('off')
	savefig("recipient_work", dpi=None, facecolor='w', edgecolor='w',
			orientation='portrait', papertype=None, format=None,
			transparent=False, bbox_inches='tight', pad_inches=0,
			frameon=None)
	plt.clf()
	VUR = str(round(float(recipient_work.count(5))/len(recipient_work),4)*100)
	recipient_dic[VUR] = "& WORKCONTACTS & " + VUR +" & " +str(wvariance) + "& \\includegraphics[width = 2cm, height = 2cm]{../recipient_work}\\\\ \n"
	...
	plt.axis('off')
	savefig("recipient_app", dpi=None, facecolor='w', edgecolor='w',
			orientation='portrait', papertype=None, format=None,
			transparent=False, bbox_inches='tight', pad_inches=0,
			frameon=None)
	plt.clf()
	VUR = str(round(float(recipient_app.count(5))/len(recipient_app),4)*100)
	recipient_dic[VUR] = "& APPSERVER & " + VUR +" & "+ str(avariance) + "& \\includegraphics[width = 2cm, height = 2cm]{../recipient_app}\\\\ \n"
	...
	plt.axis('off')
	savefig("recipient_pub", dpi=None, facecolor='w', edgecolor='w',
			orientation='portrait', papertype=None, format=None,
			transparent=False, bbox_inches='tight', pad_inches=0,
			frameon=None)
	plt.clf()
	VUR = str(round(float(recipient_pub.count(5))/len(recipient_pub),4)*100) 
	recipient_dic[VUR] = "& PUBLIC & " + VUR +" & " +str(pvariance) + "& \\includegraphics[width = 2cm, height = 2cm]{../recipient_pub}\\\\ \n"
	...
	plt.axis('off')
	savefig("recipient_total", dpi=None, facecolor='w', edgecolor='w',
			orientation='portrait', papertype=None, format=None,
			transparent=False, bbox_inches='tight', pad_inches=0,
			frameon=None)
	plt.clf()
	VUR = str(round(float(recipient_total.count(5))/len(recipient_total),4)*100)
	recipient_dic[VUR] = "& ALL & " + VUR +" & " +str(tvariance) + "& \\includegraphics[width = 2cm, height = 2cm]{../recipient_total}\\\\ \n"
	rank = 1
