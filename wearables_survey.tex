...
{\color{red} can you comment on the independence, since you have the csv? it would be a pain for me to do find out how many people got the same situational questions which only differ by recipient. :(} There might have been a perception of sharing which resulted in sharing with the public being less upsetting than sharing with work contacts--people assumed that sharing it with work was a push and sharing it to the public would require people to pull the available information which was shared.
...
A statistical analysis regarding the significance and confidence of <data> types with respect to all 74 was not performed due to the space constraints of the paper. We do consider all <data> in our regression model, which provides an analysis of what factors had contributed to the perceived severity of a particular situation. 
