...
Following the wearables scenario questions were 2 randomly selected questions from a set of 5 questions on various scenarios which can occur when using a smartphone. These five scenarios, ranging from the most upsetting scenario to the least upsetting scenario, were purposefully selected from Felt et. al's mobile user study \cite{Felt} for eliciting varying reactions from users. These questions were the basis for the five calibration wearables scenarios from the above section. Because we asked users questions differing only by the device in question, we are able to see how the change in device changes users' risk perception. Additionally, we compare our participants' perceptions of wearable device scenarios with existing perceptions of mobile device scenarios.

MENTION VUR AND WHY WE USED IT. 
...
\begin{enumerate} \itemsep1pt \parskip0pt \parsep0pt
  %\setcounter{enumi}{0}
  \item a video of you unclothed (95.97\%)
  \item bank account information (95.91\%)
  \item social security number (94.84\%)
  \item video of you entering in your PIN (92.67\%)
  \item a photo of you unclothed (92.59\%)
  \item a photo of you that is incriminating or embarrassing (91.39\%)
  \item username and password for websites (89.55\%)
  \item credit card information (88.98\%)
  \item a video of you that is incriminating or embarrassing (88.41\%)
  \item a photo you at home taken randomly by an inward-facing camera (87.50\%) \\[-.8cm]
\end{enumerate}

\begin{enumerate} \itemsep1pt \parskip0pt \parsep0pt
  \setcounter{enumi}{63}
  \item eye movement patterns (for eye tracking) (40.51\%) 
  \item when and how much you exercise (38.66\%)
  \item when you are happy or having fun (34.51\%)
  \item which television shows you watch (30.20\%)
  \item when you are busy or interruptible (29.50\%)
  \item music from your device (28.06\%)
  \item your heart rate (27.50\%)
  \item your age (24.29\%)
  \item the language you speak (15.86\%)
  \item your gender (14.91\%) \\[-.8cm]
\end{enumerate}

TALK ABOUT WHAT WAS SENSITIVE AND WHAT WAS NOT, and generally why. SAY THIS: full on stats test on all 74 data types seems unreasonable. Look at the regression model below. 
...
For not shared data (appserver only)  \\[-.8cm]
...
%sentence for each factor and why it is/isn't correlated with the very upset rate; I just put in examples sentences here to fill it in; I will change them later. 
