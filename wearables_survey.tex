...
\begin{abstract}
There exists work which addresses anticipated privacy and security challenges related to mobile and wearable devices from a system standpoint. These works generally focus on X and Y. However, works like these are not grounded in user research to make claims to the most relevant concerns for the average user. We surveyed 2,250 users about 74 data types, 4 recipients, and 2 devices to show users' perceptions of a wide range of wearables threats in a wide range of scenarios, along with an evaluation of which factors contribute to the severity of a threat. We also asked participants to rate 20 new technologies, as well as asked for what they think is the most likely risk associated with wearables. Our ranking for concerns can be used to guide future research in wearables security, especially research regarding protecting sensitive data and effective notifications and indicators. 
\end{abstract}
