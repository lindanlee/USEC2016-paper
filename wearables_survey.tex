...
\author{
 \alignauthor Linda N. Lee\textsuperscript{1}, Serge Egelman\textsuperscript{1,3}, Joong Hwa Lee\textsuperscript{2}, David Wagner\textsuperscript{1}\\
   ...
   \affaddr{\textsuperscript{2}University of California, Berkeley, \{dlwndghk94\}@berkeley.edu}\\
...
~\cite{Egelman2015} {\color{red} Serge: talk about this; you wrote it and it's not out yet.}
~\cite{bellotti1993design}: framework for designing for privacy in ubicomp.
~\cite{hong2004privacy}: privacy risk model for ubicomp. 
~\cite{jiang2002approximate}: social privacy model for ubicomp.

\subsection{Smartphones and Wearables Concerns}
%I really don't know what this first sentence means...

Designs to improve end-user security need to be grounded in user research to better understand end-user concerns. Felt \etal were among the first to examine the security concerns of smartphone users using a large-scale online survey~\cite{Felt}. Their survey asked 3,115 smartphone users about 99 risks associated with various smartphone privileges. Participants were asked how upset they would be if a certain action had occurred without their permission. Participants rated each situation on a Likert scale ranging from ``indifferent (1)'' to ``very upset (5).'' Our work builds upon this study, by aiming to evaluate the types of concerns that users have surrounding future wearable device capabilities, and then to compare those concerns to concerns surrounding more established technologies.
...
~\cite{chin2012measuring}: understanding user attitudes toward security and privacy for smartphones. 
~\cite{felt2012android}: if attention to, understand, and act on permission information during installation.
~\cite{laurier2001people}: Why people say where they are during mobile phone calls
~\cite{palen2000going}: behavior and practice of new mobile phone users
...
~\cite{acquisti2005privacy} Privacy and decision making: ppl lack enough info to make privacy-sensitive decisions; even if, likely to trade off long-term privacy for short-term benefits.
~\cite{jensen2005privacy}: Self-reports versus observed behavior
~\cite{spiekermann2001privacy}: Privacy Preferences Versus Actual Behavior
...
video of you entering in your PIN & 92.59\% \\
...
when you are happy or having fun  & 34.75\% \\
...
\hline
Question & $\chi^2$ & 2-tail P & n  & Effect Size\\
\hline
All & 2.202 & 0.1378 & 3588 & 0.001\\
