...
\section{Methodology}
%David TODO: add sentence about the methodology motivation in the overview paragraph. 
...
\subsection{ROUGH: Methodology Motivation} %LL: this text was previously inside related work
{\color{red} Note: this section is a placeholder. Maybe we should put as a subsection inside the methodology section. TODO: reword so that these works seem not like related work, but as motivation for our methodology; i.e. ``here are two methodologies from relevant work we chose to use for reasons.'' We can also say that we extend their works.}

\subsubsection{Smartphone User Concerns} %LL: this text was previously inside related work
